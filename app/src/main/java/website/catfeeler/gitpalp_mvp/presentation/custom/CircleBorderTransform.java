package website.catfeeler.gitpalp_mvp.presentation.custom;
...
public class CircleBorderTransform implements Transformation<Bitmap> {

    private final int mBorderColor;
    private BitmapPool mBitmapPool;
    private PathEffect mPathEffect = new CornerPathEffect(10);

    public CircleBorderTransform(final BitmapPool pool, final int borderColor) {
        mBitmapPool = pool;
